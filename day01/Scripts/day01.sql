...
VALUES(SEQ_MEMBER.NEXTVAL, '장화', 17, '여', '청담동');

INSERT INTO TBL_MEMBER(ID, MEMBER_NAME, MEMBER_AGE, MEMBER_GENDER, MEMBER_ADDRESS)
VALUES(SEQ_MEMBER.NEXTVAL, '홍련', 19, '여', '청담동');

SELECT * FROM TBL_MEMBER;

ALTER TABLE TBL_MEMBER ADD MEMBER_GRADE CHAR DEFAULT 2;
ALTER TABLE TBL_MEMBER MODIFY MEMEBER_GRADE VARCHAR2(255) DEFAULT 0;
ALTER TABLE TBL_MEMBER DROP COLUMN MEMEBER_GRADE;